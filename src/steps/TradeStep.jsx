  ...
  return (
    <FormSection title="Customer Allowances & Trade">
        ...
        <div className="flex gap-2 items-end">
          ...
          <button
            ...
            onClick={() => {
              ...
              // No global settings update; only update local state and localStorage
      ...
      <div>
        ...
        <input type="number" name="tradeMPG" value={dealData.tradeVehicleMpg || ''} onChange={handleFieldChange} className="block w-full rounded-md border-gray-300 shadow-sm p-2" />
      </div>
       <div>
